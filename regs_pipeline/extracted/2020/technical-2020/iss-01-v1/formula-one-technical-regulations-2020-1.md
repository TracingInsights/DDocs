...
17.[REMOVED]1[/REMOVED] Principal roll structure test

[PAGE 5]

17.[REMOVED]2[/REMOVED] Second roll structure [REMOVED]attachments[/REMOVED] test[REMOVED]s[/REMOVED]
...
APPENDIX 1 : DRAWINGS 97-105

APPENDIX 2 : POWER UNIT SYSTEMS, FUNCTIONS AND COMPONENTS 106-108

APPENDIX 3 : POWER UNIT ENERGY FLOW 109-110
...
In order to prevent tyre damage to other cars, the complete endplate, with the exception of parts of the second volume inboard of the virtual endplate surface must be at least 10mm thick (being the minimum distance when measured normal to the surface in any direction) with a 5mm radius applied to all extremities. In addition, the leading 50mm of this bodywork[REMOVED], with the exception of fasteners and inserts as described below,[/REMOVED]must be of a prescribed laminate, details of this laminate may be found in the Appendix to the Technical Regulations. [REMOVED]Fasteners and related inserts, for the purpose of attaching the front wing endplate to the profiles must be positioned at least 30mm rearward of the leading edge of the endplate.[/REMOVED]
...
[REMOVED]d) In side view, the projected area of any bodywork lying between 550mm and 730mm above the reference plane and between 200mm and 450mm forward of the rear wheel centre line must be greater than 44990mm2.[/REMOVED]
...
a) Other than inserts within them, engine crankcases including sump, cylinder heads and cylinder head cam covers must be manufactured from [REMOVED]cast or wrought[/REMOVED] aluminium or iron alloys. No composite materials or metal matrix composites are permitted either for the whole component or locally.
...
**6.1.2** When viewed in lateral projection, all the fuel stored on board the car must be situated between the forward-most of the two vertical planes referred to in Article 5.3.7 and the line a- b-c in Drawing 2. Furthermore, no fuel can be stored more than 300mm forward of point c) in Drawing 2. However, a maximum of [REMOVED]0.25[/REMOVED] litres of fuel may be kept outside the survival cell, but only that which is necessary for the normal running of the engine.
...
**9.2.1** [REMOVED]Clutch operating devices must be in the form of paddles, which comply with the following principles:[/REMOVED]

[CHANGED]a)[/CHANGED][REMOVED]There should be a maximum of two, mounted on the steering wheel for direct access in all circumstances.[/REMOVED]

[CHANGED]b)[/CHANGED][REMOVED]They should be of pull-type, opening the clutch when pulling the paddle towards the driver.[/REMOVED]

[CHANGED]c)[/CHANGED][REMOVED]Their travel should be in a plane nominally normal to the face of the steering wheel, with a maximum displacement of the driver’s contact surfaces of 80mm between end stops.[/REMOVED]

[CHANGED]d)[/CHANGED][REMOVED]They should have only a single degree of freedom.[/REMOVED]

[CHANGED]e)[/CHANGED][REMOVED]Where two paddles are fitted, they must be a left and right handed pair, identical in function and ergonomics, mounted in a symmetrically opposite manner on either side of the steering wheel centre plane. For the avoidance of doubt, they must have the same mechanical travel characteristics and be mapped identically. No interaction between them or the associated FIA ECU inputs will be permitted and, furthermore, competitors must be able to demonstrate beyond any doubt that each of the paddles may only be operated with only one hand.[/REMOVED]

[CHANGED]f)[/CHANGED][REMOVED]To ensure that the signals used by the FIA ECU are representative of the driver’s actions, each competitor is required to demonstrate that the paddle percentage calculated by the ECU does not deviated by more than +/-5% from the physical position of the operating device measured as a percentage over its entire usable range. In that context, the physical position of the paddle will be measured at the location operated by the fingers.[/REMOVED]

**9.2.2** Designs which allow specific points along the travel range of the clutch operating device to be identified by the driver or assist him to hold a position are not permitted. [REMOVED]In order to prevent interaction between the clutch paddles and other driver control devices, at least one of the following arrangements must be respected:[/REMOVED]

[CHANGED]a)[/CHANGED][REMOVED]When pulled to its maximum travel position, any clutch paddle should not reach further than the driver’s contact surfaces of any other paddle, lever or switch in any of their positions.[/REMOVED]

[CHANGED]b)[/CHANGED][REMOVED]The outboard 60% portion of any clutch paddle, measured from its mounting point to its outer edge by the driver’s contact surface, should be a minimum of 50mm away over its entire travel range from any other paddle, lever or switch.[/REMOVED]

[CHANGED]c)[/CHANGED][REMOVED]A clutch paddle should be separated from any adjacent paddle, lever or switch by a physical stop preventing any practical interaction between them by the driver. Such stop should be sized and shaped so that it cannot be used as a reference point during paddle operation. In addition, other parts of the steering wheel or chassis should not be practically usable as reference points for the driver to identify or hold a specific position.[/REMOVED]
...
f) Test signals enabled only when the car is connected to the garage system. [REMOVED]When commanded by the driver, the amount of clutch engagement will be expressed in the FIA ECU as torque at the rear axle by applying a gain of 4500Nm / 90% to the clutch paddle position between 5% and 95%. In that case the clutch torque controller implemented in the FIA ECU must be used. Except for the first 70ms following the initial step in clutch torque demand during a launch, the control error, calculated using the power unit output shaft torque sensor, must be contained in a band of +/-150Nm when converted at the rear axle.[/REMOVED]
...
b) Must not protrude beyond a radius of 180mm from the centre of the wheel, when viewed from the side. [REMOVED]For any part of the air duct which is in contact with the external air stream and between 120mm and 5mm inboard of a plane parallel with the inner face of the wheel rim, the following conditions must be satisfied:[/REMOVED]

[PAGE 63]

c) [REMOVED]Any[/REMOVED]intersection with [REMOVED]a[/REMOVED] vertical lateral or horizontal plane must produce a single tangent-continuous curve. Furthermore, this tangent-continuous curve must be fully visible when viewed from the car centre plane.

d) [REMOVED]The local radius of curvature must be greater than 20mm. In order to fulfil this criterion, it should be possible to apply a tangent sphere of radius 20mm to any point of these surfaces (and on both sides), without intersecting any other part of these surfaces.[/REMOVED]

e) Any [REMOVED]intersection with a[/REMOVED]vertical longitudinal [REMOVED]plane[/REMOVED] must produce a single closed section All parts of the air duct more than 5mm inboard of a plane parallel to the inner face of the wheel rim must fit entirely between two planes which are parallel to the reference plane and separated by 180mm.

**11.4.2** Once the geometry has been defined in accordance to Article 11.4.1, the following apertures may be added :

a) A single aperture [REMOVED]may be applied to the part of the air duct which is in contact with the external air stream and between 120mm and 5mm inboard of a plane parallel with the inner face of the wheel rim. This aperture must be:[/REMOVED]

i) Fully visible from the front of the car and may not be taller than 180mm when measured normal to the reference plane. ii) Constructed such that no point on [REMOVED]its[/REMOVED] periphery is more than 50mm from any other [REMOVED]such[/REMOVED]point when measured normal to plane A-A. [REMOVED]iii) Entirely forward of the front wheel centre line.[/REMOVED]
...
**14.3.1** [REMOVED]All cars must have two mirrors positioned symmetrically about the car’s centre plane and mounted so that the driver has visibility to the rear and both sides of the car: mirrors must[/REMOVED]

[PAGE 69]

[REMOVED]remain immobile in relation to the sprung part of the car. Mirrors should be virtually removed for all legality aspects of Article 3 to be satisfied. A mirror is defined to be the assembly of the following components:[/REMOVED][CHANGED]-[/CHANGED][REMOVED]one reflective surface[/REMOVED][CHANGED]-[/CHANGED][REMOVED]its housing[/REMOVED][CHANGED]-[/CHANGED][REMOVED]mountings which connect the housing to the sprung part of the car.[/REMOVED]

**14.3.2** [REMOVED]The reflective surface of each mirror must be a rectangle which is 150mm wide and 50mm high (+2mm/-0mm for both dimensions), with a radius no greater than 10mm applied to each corner. The reflective surface must be contained within the housing described in the article 14.3.3. Non-planar reflective surfaces are permitted provided that they can project onto a rectangle of the dimensions specified in this Article.[/REMOVED]

**14.3.3** [REMOVED]The housing must be contained within a volume that has:[/REMOVED]

[CHANGED]a)[/CHANGED][REMOVED]Upper and lower faces parallel to the reference plane and separated by 80mm[/REMOVED]

[CHANGED]b)[/CHANGED][REMOVED]Inner and outer faces parallel to the car centre plane and separated by 160mm[/REMOVED]

[CHANGED]c)[/CHANGED][REMOVED]A rear face normal to the reference plane, at an angle of between 60° and 70° to the car centre plane with its outer edge rearwards of its inner edge[/REMOVED]

[CHANGED]d)[/CHANGED][REMOVED]A front face parallel to and 75mm forward the rear face when measured in the direction of the car centre line The lower rear inboard vertex of this volume must lie between 605mm and 730mm forward of plane C-C, between 420mm and 470mm from the car centre plane and between 600mm and 640mm above the reference plane. No part of the housing or its mountings may obstruct the driver’s rearward vision.[/REMOVED]

**14.3.4** There must be no more than two mountings connecting the mirror housing to the bodywork.

a. A maximum of one mounting may connect the mirror housing to the survival cell. Such a mirror mounting must: [CHANGED]-[/CHANGED]Lie between two vertical lateral planes,[REMOVED]located at the forward and rearward extremities of the inboard face of the volume defined in the article 14.3.3[/REMOVED]- Lie between two horizontal planes, one 550mm above the reference plane, and one [REMOVED]parallel to and offset upward by 25mm from the lower face of the volume defined in the article 14.3.3[/REMOVED]- Lie inboard of the [REMOVED]inboard face of the volume defined in 14.3.3[/REMOVED]- Form no more than a single section when intersected by any longitudinal vertical or horizontal plane

b. Any other mirror mounting must lie in its entirety between two vertical longitudinal planes which pass through the innermost and outermost point of the [REMOVED]volume defined in the article 14.3.3[/REMOVED], and when viewed from above must not protrude more forward than [REMOVED]the volume defined in the article 14.3.3[/REMOVED] or more than 50mm rearward than the diagonal line defined in Article 3.5.5 (d). Furthermore, any intersection of each such mirror mounting with a vertical lateral plane must: - Form a single section - Be no more than 50mm high or 10mm wide

[PAGE 70]

- Lie between 550mm above the reference plane and [REMOVED]a horizontal plane that passes through the lower face of the volume defined in 14.3.3[/REMOVED]
...
[CHANGED]f)[/CHANGED][REMOVED]Extend as far forward as the leading edge of the helmet free volume (the details of which may be found in the Appendix to the Technical Regulations) The cover and its internal structure must have no features that obstruct its freedom to compress to 5% of its uncompressed thickness[/REMOVED]
...
2020 F1 Technical Regulations 98/110 30 April 2019 © 2019 Fédération Internationale de l’Automobile

[PAGE 99]

2020 F1 Technical Regulations 99/110 30 April 2019 © 2019 Fédération Internationale de l’Automobile

[PAGE 100]

2020 F1 Technical Regulations 100/110 30 April 2019 © 2019 Fédération Internationale de l’Automobile

[PAGE 101]

2020 F1 Technical Regulations 101/110 30 April 2019 © 2019 Fédération Internationale de l’Automobile

[PAGE 102]

2020 F1 Technical Regulations 102/110 30 April 2019 © 2019 Fédération Internationale de l’Automobile

[PAGE 103]

2020 F1 Technical Regulations 103/110 30 April 2019 © 2019 Fédération Internationale de l’Automobile

[PAGE 104]

2020 F1 Technical Regulations 104/110 30 April 2019 © 2019 Fédération Internationale de l’Automobile

[PAGE 105]

2020 F1 Technical Regulations 105/110 30 April 2019 © 2019 Fédération Internationale de l’Automobile

[PAGE 106]

# APPENDIX 2: POWER UNIT SYSTEMS, FUNCTIONS AND COMPONENTS

2020 F1 Technical Regulations 106/110 30 April 2019 © 2019 Fédération Internationale de l’Automobile
...
2020 F1 Technical Regulations 107/110 30 April 2019 © 2019 Fédération Internationale de l’Automobile
...
| 22 | Brackets, supports, screws, nuts, dowels, washers or cables associated to the parts listed in line [REMOVED]21[/REMOVED]. | [CHANGED]INC[/CHANGED] |  |  | [CHANGED]EXC[/CHANGED] |  |  | [CHANGED]INC[/CHANGED] |  |  | [CHANGED]EXC[/CHANGED] |  |  | [CHANGED]EXC[/CHANGED] |  |  | [CHANGED]INC[/CHANGED] |  |  |
...
2020 F1 Technical Regulations 108/110 30 April 2019 © 2019 Fédération Internationale de l’Automobile

[PAGE 109]

# APPENDIX 3: POWER UNIT ENERGY FLOW

2020 F1 Technical Regulations 109/110 30 April 2019 © 2019 Fédération Internationale de l’Automobile

[PAGE 110]

2020 F1 Technical Regulations 110/110 30 April 2019 © 2019 Fédération Internationale de l’Automobile
