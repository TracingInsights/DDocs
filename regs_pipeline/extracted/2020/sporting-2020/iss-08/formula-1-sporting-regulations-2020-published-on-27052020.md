# 2020 Formula One Sporting Regulations — Issue 08
...
[CHANGED]d)[/CHANGED]A list of all operational, exempt, trainee and single race personnel must be submitted to the FIA prior to each Event using the official template that may be found in the Appendix to these Sporting Regulations.
...
All competitors must observe a shutdown period of sixty-three consecutive days during the months of March, April, May and/or June. Each competitor must notify the FIA of their intended shutdown period no later than 24 hours prior to its commencement. During the shutdown period no team or affiliate to a team may carry out or instruct a third party supplier to carry out any of the following activities for or on behalf of the team:
...
If a driver has serious mechanical difficulties[CHANGED],[/CHANGED] he must leave the track as soon as it is safe to do so.
...
b) At certain Events one additional specification[CHANGED]s[/CHANGED] of dry-weather tyre[CHANGED]s[/CHANGED] may be made available to all teams [CHANGED]competitors[/CHANGED]for evaluation purposes following a recommendation to the FIA from the Supplier. [CHANGED]In such cases:[/CHANGED]

[CHANGED]i) Testing of these additional specifications will be mandatory for all cars, unless the car in question has suffered irreparable damage. ii) Testing of these additional specifications must be carried out in the last 30 minutes of P2. The Supplier will specify the testing schedule for each competitor during this time interval. Any other on track and/or testing activity not specified by the Supplier is not permitted. iii) Each competitor may not necessarily be given the same tyre specifications to evaluate. The total number of laps required from each car during this time interval will be the same for all cars.[/CHANGED]Teams [CHANGED]Competitors[/CHANGED]will be informed about such an additional specification[CHANGED]s[/CHANGED]at least one [CHANGED]two[/CHANGED]week[CHANGED]s[/CHANGED] before the start of the relevant Event.
...
b) The only sets of tyres which may be used during an Event are those which are defined in Article 24.2(a). Any driver who uses a set of tyres of differing specifications during the race may not complete more than three laps on this set before changing them for a set of tyres of the same specification. A penalty under Article 38.3(d) will be imposed on any driver who
...
ii) At the end of the qualifying session all cars which took part in Q3 will be weighed. If a driver wishes to leave his car before it is weighed[CHANGED],[/CHANGED] he must ask the technical delegate to weigh him in order that this weight may be added to that of the car. iii) If a car stops on the circuit during the qualifying session and the driver leaves the car, he must go to the FIA garage immediately on his return to the pit lane in order for his weight to be established.

b) After the race any classified car may be weighed. If a driver wishes to leave his car before it is weighed[CHANGED],[/CHANGED] he must ask the technical delegate to weigh him in order that this weight may be added to that of the car.
...
During all practices there will be a green and a red light at the end of the pit lane. Cars may only leave the pit lane when the green light is on. Additionally, a blue flag and/or a flashing blue light
...
not to stop, provided he carries out no further pit stop before the end of the race. In such cases ten seconds will be added to the elapsed race time of the driver concerned. In both of the above cases the driver concerned must carry out the penalty the next time he enters the pit lane and, for the avoidance of doubt, this includes any stop the driver makes whilst a VSC or safety car procedure is in use.
...
# APPENDIX 4: 2017-20250 POWER UNIT HOMOLOGATION

1) Any manufacturer intending to homologate a power unit for use by a team in a Championship during the 2017-202[CHANGED]5[/CHANGED]0 period must submit to the FIA a power unit homologation dossier on or before 28 February of the relevant year. 2) The homologation dossier must include:
...
# APPENDIX 7: ENTRY FEES FOR THE 2020 FIA FORMULA ONE WORLD CHAMPIONSHIP

i) The winner of the 2019 World Championship for Constructors will be required to pay a basic fee of US$556,5091 plus US$6,6771 for each point gained in the 2019 World Championship for Constructors. ii) Every other competitor will be required to pay a basic fee of US$556,5091 plus US$5,5631 for each point that competitor gained in the 2019 World Championship for Constructors. In both cases the basic fee is due at the time of the application and the remainder by 10 December of the year prior to the year to which this application relates.
...
In the context of this Appendix the words bodywork, sprung suspension and brake system air ducts will have the same definition as those provided by Articles 1.4, 1.13, 11.4, 11.5 and 11.6 of the F1 Technical Regulations respectively.
...
RCFDs refer to the solver part of the process (irrespective of the numerical scheme behind the simulation) plus any mesh adaptation included in a solver optimisation loop. Pre-processing,
...
For each aerodynamic reporting period defined in the Appendix to the F1 Sporting Regulations, for each nominated computer/cluster, each competitor must use either ‘Option A’ in Paragraph

## 2.7

or ‘Option B’ in Paragraph 2.8 for declaring RCFDs.

## 2.7 RCFD simulations Option A:

**2.7.1** RCFD simulations declared using Option A may only be carried out using hardware that has been nominated by the competitor to the FIA. Each competitor must declare to the FIA in writing the computer resource that is employed for the purpose of RCFD simulations. The declaration of the hardware by the competitor to the FIA must include:
...
c) Processor speed at which the Processing Unit is configured to run at 100% CPU load. CCF referred to in paragraph 2.7.2. If the hardware is changed or upgraded then a new declaration must be submitted to the FIA within one month of the change or at the time of submission of a testing period report whichever is earlier. Such changes might include, but are not limited to, a change of the hardware specification, addition or removal of processing units, change of location of any part of the hardware.

**2.7.2** The calculation used for the declaration of the 8 week Aerodynamic Testing Period shall be carried out as below. AUh = (NCU * NSS * CCF) / 3600 Where : AUh = The total number of Unit hours allocated to a CFD job. An Allocation Unit hour represents the use of a unit of resource allocation for one hour (and 1 x MAUh = 1,000,000 x AUh). For CPUs an Allocation Unit hour is equivalent to a core- hour. CCF = Peak Processing Unit clock frequency in GigaHertz achieved during the CFD solver run. This will be the peak frequency theoretically achievable during the run based on one of the following:
...
c) The maximum overclocked frequency value. NCU = Number of Processing Unit cores used for the run. NSS = Number of solver wall clock seconds elapsed during the run. Message passing time during calculation must be included. All information required for auditing should be present in the output from the run including the CCF value.
...
**2.8.1** RCFDs declared using Option B may only be carried out using hardware that has originally been nominated by the competitor to the FIA on or before 1 January 2017. The declaration of the hardware by the competitor to the FIA must include:
...
h) Maximum TeraFLOPs (FLOP = double precision floating point operation) the system can use. This may exclude any AVX floating point operations if declared under Paragraph 2.8.1

d) or include natural precision operations under Paragraph 2.8.1 e). For the avoidance of doubt, any RCFD carried out on behalf of or for the benefit of the competitor by an Associate (as defined in Section 8 of Appendix 6), a contracted party of the competitor or of any Associate of the competitor or any external entity working on behalf of the competitor or for its own purposes and subsequently providing the results of its work to a competitor must be carried out using the hardware nominated by the competitor, with the exception of RCFDs performed to collect the data necessary for the correct operation of non-

[PAGE 64]

Listed Parts supplied by another competitor as defined in Paragraph 3 of Appendix 6 and declared by that competitor. If the hardware is changed then an updated declaration must be submitted to the FIA within one month of the change or at the time of submission of a testing period report whichever is earlier. Such changes might include removal of processing units or change of location of any part of the hardware.

**2.8.2** The calculation used for the declaration of the eight week Aerodynamic Testing Period (ATP) shall be carried out as below. TotFLOPs = (MFPPC * CCF * NCU * NSS ) / (604,800 * 8 * 1000) Where: TotFLOPs = The total number of TeraFLOPs used per CFD solve run. MFPPC = Peak double precision floating point operations per cycle per core of the processing unit (excluding AVX if declared under Paragraph 2.8.1 d) or using natural precision operations under Paragraph 2.8.1 e) if the core is not double precision capable). CCF = Peak processing unit clock frequency in GigaHertz achieved during the CFD solver run. This will be the peak frequency theoretically achievable during the run based on one of the following:
...
Availability of Hardware Any hardware must be available on a non-exclusive basis to all competitors.

# ARTICLE 3: Combined RWTT and RCFDs Restriction

## 3.1

The usage limits for RWTT and RCFDs are expressed in terms of Wind On Time, number of runs, tunnel occupancy, CFD AUh usage and CFD TeraFLOPs usage during an ATP.
...
CFD MAUh Usage is defined as the sum of the number of Mega Allocation Unit hours used for the purpose of making RCFD simulations during the ATP. CFD TeraFLOP usage is defined as the

[PAGE 65]

average number of TeraFLOPs of computing power used for the purpose of making RCFDs during the ATP. For the avoidance of doubt, computer resource used for RCFDs that fail or are aborted by the user must still be included in the CFD MAUh or CFD TeraFLOP usage calculation. For the further avoidance of doubt any RCFDs performed for the competitor by any Associate of the competitor (as defined in Section 8 of Appendix 6) and/or by any contracted party of the competitor or of any Associate of the competitor or any external entity working on behalf of the competitor or for its own purposes and subsequently providing the results of its work to the competitor during an ATP must be included in this calculation as if the simulations were performed by the competitor.
...
The Limit Line is defined as follows: WT <= WT_limit (1 – CFDA/CFDA_limit – CFDB/CFDB_limit) Where: WT = Wind On Time WT_limit = 25 hours And for RCFD Simulations Option A: CFDA = CFD MAUh Usage CFDA_limit = 10 MAUh And for RCFD Simulations Option B: CFDB = CFD TeraFLOP usage CFDB_limit = 25 TeraFLOPs [CHANGED]And the values of: WT_limit, CFDA_limit and CFDB_limit are in accordance with the table in paragraph 3.8[/CHANGED]

## 3.7

Each competitor must also limit RWTT to a maximum [CHANGED]total number[/CHANGED]of 65 runs per week and a maximum of 60 [CHANGED]total number of hours[/CHANGED]of tunnel occupancy per week both averaged over the [CHANGED]in any[/CHANGED]ATP [CHANGED]according to the values in the table in paragraph 3.8.[/CHANGED]Only two shifts of occupancy may be carried out in any one calendar day. At the end of each ATP it will also have to be demonstrated that the competitor has operated according to these limits. For the avoidance of doubt any RWTT performed for the competitor by any Associate of the competitor (as defined in Section 8 of Appendix 6) and/or by any contracted party of the competitor or of any Associate of the competitor or any external entity working on behalf of the competitor or for its own purposes and subsequently providing the results of its work to the competitor during an ATP must be included in this calculation as if the tests were performed by the competitor.

## 3.8

[CHANGED]The values defining the Limit Line and the maximum runs and occupancy hours permitted for RWTT will be determined according to the ATPs defined in paragraph 4.4 and the shutdown period described in Article 21.8 of the F1 Sporting Regulations, as in the table below:[/CHANGED]

| [CHANGED]Value[/CHANGED] | [CHANGED]Units[/CHANGED] | [CHANGED]Until end of ATP 1[/CHANGED] | [CHANGED]For ATP 2 onwards if shutdown period <=21 weeks in duration[/CHANGED] | [CHANGED]For ATP 2 onwards if shutdown period >21 weeks in duration[/CHANGED] |
|---|---|---|---|---|
| [CHANGED]WT_limit[/CHANGED] | [CHANGED]hours[/CHANGED] | [CHANGED]25[/CHANGED] | [CHANGED]20[/CHANGED] | [CHANGED]25[/CHANGED] |
| [CHANGED]CFDA_limit[/CHANGED] | [CHANGED]MAUh[/CHANGED] | [CHANGED]10[/CHANGED] | [CHANGED]8[/CHANGED] | [CHANGED]10[/CHANGED] |
| [CHANGED]CFDB_limit[/CHANGED] | [CHANGED]Tflops[/CHANGED] | [CHANGED]25[/CHANGED] | [CHANGED]20[/CHANGED] | [CHANGED]25[/CHANGED] |

[PAGE 66]

| [CHANGED]RWTT Runs[/CHANGED] | [CHANGED]#[/CHANGED] | [CHANGED]520[/CHANGED] | [CHANGED]410[/CHANGED] | [CHANGED]520[/CHANGED] |
|---|---|---|---|---|
| [CHANGED]RWTT Occupancy[/CHANGED] | [CHANGED]hours[/CHANGED] | [CHANGED]480[/CHANGED] | [CHANGED]390[/CHANGED] | [CHANGED]480[/CHANGED] |
...
Any data acquired during RWTT and RCFD may only be available to the competitor that is assigned the Wind On Time or CFD MAUh and/or TeraFLOPs used to acquire it, with the exception of the data necessary for the correct operation of non-Listed Parts supplied to another competitor as defined in Paragraph 3 of Appendix 6.

## 3.11

The limits in CFD simulation (“CFDA_limit” and “CFDB_limit” in the Limit Line) will be revised every three years, starting from 1st January 2018, to a new performance level to take account of changes to CFD hardware ownership and running costs.
...
a) The [CHANGED]dates of the[/CHANGED]aerodynamic reporting periods may be found in the Appendix to the F1 Sporting Regulations. [CHANGED]will be as follows:[/CHANGED]

[CHANGED]i) Period 1 will start on the 10 February and end a period of days after the 5 April of the same duration as the shutdown period required by Article 21.8 of the F1 Sporting Regulations, except where fewer than 4 weeks of the year would remain in which case it shall be the sole ATP. ii) The final period will be a minimum of 4 and maximum 12 weeks duration and end on the 31 December. Any intervening periods will each be of 8 weeks duration. iii) For illustration, should the shutdown period be 9 weeks duration, period 2 would start on the 8 June and run for 8 weeks, Periods 3 and 4 would run for 8 weeks and the final period 5 would run for 5 weeks and 4 days.[/CHANGED]

b) If an Aerodynamic Reporting Period occupies more [CHANGED]a different number of active calendar weeks[/CHANGED]than 8 calendar weeks in order to [CHANGED]either[/CHANGED]span the factory shutdown [CHANGED]or to finish on[/CHANGED]

[PAGE 67]

[CHANGED]31 December[/CHANGED], Wind-on time,[CHANGED]and[/CHANGED]TeraFLOPs, occupancy will be averaged and runs over this reporting period, or any other period which duration may not be 8 weeks, by summing the total activity in the period and then averaging over the effective duration of the ATP exactly as for a normal reporting period. [CHANGED]MAUh, runs and occupancy will be summed over the period and the totals adjusted pro-rata according to the effective duration of the period compared to 8 weeks and will then be evaluated exactly as for a normal period.[/CHANGED]

c) For a new entrant, the reporting will start as soon as it officially becomes a competitor. The start date of the first reporting period will be defined as the date at which it officially becomes a competitor and wind-on time, TeraFLOPs, occupancy and runs will be averaged [CHANGED]or summed pro-rata[/CHANGED]over the duration of this reporting period.
...
Twelve million euros (unless agreed otherwise between the Power Unit Manufacturer and the New Customer Team). Notwithstanding the above, the Price shall not be applicable to any customer team who is at any time in breach of its payment obligations to the Power Unit Manufacturer under any supply agreement. The Price will be reviewed by the Power Unit Manufacturers and the FIA in good faith and amended accordingly should the F1 governing bodies decide any change to the Power Unit Technical and Sporting Regulations1 that would materially affect the financial conditions concerning the supply of power units (except if the change is supported by at least 75% of the Power Unit Manufacturers which, at the date of the consultation, are supplying power units in the corresponding Championship season and have not officially announced their intention to stop supplying power units to teams in any subsequent Championship season).
...
| 15 | ES parts defined in article 5.4.3[CHANGED]of F1 Technical Regulations[/CHANGED] |  | [CHANGED]INCLUDED[/CHANGED] |  |
| 16 | ES excluding parts defined in article 5.4.3[CHANGED]of F1 Technical Regulations[/CHANGED] |  | [CHANGED]INCLUDED[/CHANGED] |  |
...
| 36 | Ballast mounted on the PU up to 2kg. This is permitted (subject to Article 4 [CHANGED]of the F1 Technical Regulations[/CHANGED]) but any in excess of 2kg will be removed before measuring PU weight. | [CHANGED]INCLUDED[/CHANGED] |  |  |
...
[CHANGED]v) Number of ERS Test Bench: • Before the 1st December of the preceding year: Declaration from the PU supplier of the number of ERS test benches to be used in a calendar year (=Name, description, location)). This includes any bench whatever their location, ownership or duration of use during the calendar year. • 2 weeks before each 10 weeks period:  Designation by the PU supplier of the benches that will be used for the period  No limitation of the number of changes per calendar year but all benches must be among the ones declared at the start of the year. • In order to check on the hardware employed by the PU manufacturers and as a mean of assuring common application of the restrictions set out, the FIA will arrange for independent benchmarking inspections of dynos activities to be carried out from time to time. vi) Test bench occupancy: • Sum of each individual bench occupancy hours: Total Occupancy hours: OCH 𝑛𝑛=𝑁𝑁 OCH = ෍𝑁𝑁𝑁𝑁𝑁𝑁𝑁𝑁𝑁𝑁 𝑛𝑛=1 With:  N = Number of test benches  NOCHn= Number of occupancy hours during the period for bench number n • Declaration 14 days after each 10 weeks period from PU manufacturers signed by top management. • PU manufacturers must keep records of bench tests until 1 month after the end of the calendar year vii) Test Bench Operation Hours: • Sum of each individual bench operation hours.[/CHANGED]

[PAGE 83]

[CHANGED]Total Operation hours: OPH 𝑛𝑛=𝑁𝑁 OPH = ෍𝑁𝑁𝑁𝑁𝑁𝑁𝑁𝑁𝑁𝑁 𝑛𝑛=1 With:  N = Number of test benches  NOPHn= Number of operation hours during the period for bench number n • Declaration 14 days after each 10 weeks period from PU manufacturers signed by top management • PU manufacturers must keep records of bench tests until 1 month after the end of the calendar year[/CHANGED]

[CHANGED]d) Limitations:[/CHANGED]

| [CHANGED]Year[/CHANGED] | [CHANGED]2020[/CHANGED] | [CHANGED]2021[/CHANGED] | [CHANGED]2022[/CHANGED] | [CHANGED]2023[/CHANGED] | [CHANGED]2024[/CHANGED] | [CHANGED]2025[/CHANGED] |
|---|---|---|---|---|---|---|
| [CHANGED]Max test benches[/CHANGED] | [CHANGED]4[/CHANGED] | [CHANGED]4[/CHANGED] | [CHANGED]4[/CHANGED] | [CHANGED]4[/CHANGED] | [CHANGED]4[/CHANGED] | [CHANGED]4[/CHANGED] |
| [CHANGED]Max Occupancy hours[/CHANGED] | [CHANGED]1080*[/CHANGED] | [CHANGED]1600[/CHANGED] | [CHANGED]1600[/CHANGED] | [CHANGED]1600[/CHANGED] | [CHANGED]1600[/CHANGED] | [CHANGED]1600[/CHANGED] |
| [CHANGED]Max Operation hours[/CHANGED] | [CHANGED]270*[/CHANGED] | [CHANGED]400[/CHANGED] | [CHANGED]400[/CHANGED] | [CHANGED]400[/CHANGED] | [CHANGED]400[/CHANGED] | [CHANGED]400[/CHANGED] |

[CHANGED]* 2020 limitation: To be considered for the last 3 periods of 10 weeks each maximum.[/CHANGED]
