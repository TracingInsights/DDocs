# 2020 Formula One Sporting Regulations — Issue 10
...
i) Which tyre specifications will be made available by the Supplier. ii) The mandatory dry-weather race tyre specification(s) (up to two). iii) The mandatory dry-weather Q3 tyre specification (which will always be the softest of the three specifications). Each Driver will be allocated the following specification of dry-weather tyres at each Event:
...
e) If an additional specification of dry-weather tyre is made available in accordance with Article 24.1(b) two sets of these tyres will be allocated to each driver for use during P1

[PAGE 22]

and P2. Any such tyres must be electronically returned no later than two hours after the end of P2.
...
When the five minute signal is shown all cars on the grid must have their wheels fitted, after this signal wheels may only be removed in the pit lane and team personnel and equipment trolleys must commence leaving the grid.

[PAGE 33]

A penalty under Article 38.3(d) will be imposed on any driver whose car did not have all its wheels fully fitted at the five minute signal.
