# 2023 Formula One Sporting Regulations — Issue 01
...
[CHANGED]Pink text:[/CHANGED]Changes for 2023 approved by the WMSC up to and including 29/6/22

[CHANGED]Pink highlighted text:[/CHANGED]Changes for 2023 approved by the WMSC on 19/7/22
...
A sprint session will take place at up to three (3) Competitions.
...
| Penalties will | [REMOVED]be vary between the first time an additional RNC is used, or the[/REMOVED] |  |
|---|---|---|
| [REMOVED]subsequent times,[/REMOVED] |  | in accordance with the relevant columns of the table of this |

Article.

[CHANGED]c) If two additional RNCs are fitted to the same gearbox assembly the first time each of these are used, the penalty will be the maximum of the penalty stated between the two types of RNC in the table of this Article, not the sum of the two penalties.[/CHANGED]
...
| end of P1 | [CHANGED], unless the driver is a replacement driver under the provisions of[/CHANGED] |  |
|---|---|---|
| [CHANGED]Article 32.4c) in which case two (2) sets must be returned[/CHANGED] |  | . |
