...
[CHANGED]PUBLISHED ON 12 OCTOBER 2018[/CHANGED]
...
[REMOVED]No one under the age of 16 is allowed in the pit lane at the following times :[/REMOVED]
...
i) The last eight positions will be occupied by the cars eliminated during Q1, the fastest in 19th position. ii) The next eight positions will be occupied by the cars eliminated during Q2, the fastest in 11th position.
...
d) Any driver who incurs a penalty under Article 23.3(e) or Article 23.5(a) will take precedence over any driver whose qualifying times have been deleted for any reason. If more than one driver falls into a single category in b) or d) above they will be arranged on the grid in the order they were classified in the previous period of qualifying or, in the case of Q1, the order they were classified in P3.
...
32 minutes before the scheduled start of the formation lap, a warning signal will be given indicating that the end of the pit lane will be closed in two minutes.
...
i) The winner of the [REMOVED]2018[/REMOVED] World Championship for Constructors will be required to pay a basic fee of US$516,128[REMOVED]1[/REMOVED] plus US$61941 for each point gained in the [REMOVED]2018[/REMOVED] World Championship for Constructors. ii) Every other competitor will be required to pay a basic fee of US$516,1281 plus US$51611 for each point that competitor gained in the [REMOVED]2018[/REMOVED] World Championship for Constructors. In both cases the basic fee is due at the time of the application and the remainder by 30 November of the year prior to the year to which this application relates.
...
**2.7.2** The calculation used for the declaration of the eight week Aerodynamic Testing Period (ATP) shall be carried out as below. TotFLOPs = (MFPPC * CCF * NCU * NSS ) / (604,800 * 8 * 1000) Where : TotFLOPs = The total number of TeraFLOPs used per CFD solve run. MFPPC = Peak double precision floating point operations per cycle per core of the processing unit (excluding AVX if declared under Paragraph 2.7.1(d) or using natural precision operations under Paragraph 2.7.1(e) if the core is not double precision capable). CCF = Peak processing unit clock frequency in GigaHertz achieved during the CFD solver run. This will be the peak frequency theoretically achievable during the run based on one of the following :
