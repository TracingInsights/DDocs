# 2026 Formula 1 Regulations : Operational Regulations — Issue 04
...
Black Text: Text unchanged from 2026 F1 Regulations - Section F \[Operational\] – Iss 03 Approved by the

WMSC on 30/07/2025

[CHANGED]\[Pink Text\]: Changes approved by the WMSC on 16/10/2025[/CHANGED]
...
**F5.1.2** Single-Cylinder Dynamometer A “Single-Cylinder Dynamometer” is a test bench facility cell where a fired engine with only one cylinder[CHANGED],[/CHANGED] representative of a Formula 1 engine can be tested. In addition to test bench components, this bench may include and is limited to the following Power Unit and car components:
...
**F5.2.1** Testing Periods[CHANGED]and Performance Assessment Periods[/CHANGED]The usage of PUTBs has an annual limit (defined in Article F5.2.7) and is furthermore controlled by five Testing Periods of ten working weeks each. The calendar will be shared by the FIA at the end of the previous year. [CHANGED]The performance of each PU Manufacturer’s ICE will be measured during Competitions, over defined periods during each year. These periods of measurement are described in Article 4 of Appendix C5 of the Technical Regulations. These measurements being used to determine whether the PU Manufacturer meets the criteria for “Additional Development and Upgrade Opportunities” (ADUO) the results will then modify the PUTB limits and be applied according to Articles F5.2.3 and F5.2.7.[/CHANGED]
...
**F5.2.7** Limitations in Restricted PUTB testing In each year, the limits of PUTB testing for the 2026 PU are summarised in the following table[CHANGED]s[/CHANGED]: [CHANGED]Table 1. Base limits[/CHANGED]

| 2026 PU limit - ICE |  |  | 300 | 5430 * |  |  | 710 | 410 | 410 | 410 | 410 |
|---|---|---|---|---|---|---|---|---|---|---|---|

* These limits are cumulative over the three years, N-3, N-2, N-1. For the period N-3, N-2, N-1, each year will have individual ICE Operation hours and ICE Occupancy hours limits equal to 40% of the total cumulative allowance for these three years. [CHANGED]Table 2. ADUO Operation Hours[/CHANGED]

|  | [CHANGED]Delta Performance Index[/CHANGED] |  | [CHANGED]<2%[/CHANGED] | [CHANGED]2% ≤X<4%[/CHANGED] | [CHANGED]4% ≤X<6%[/CHANGED] | [CHANGED]6% ≤X<8%[/CHANGED] | [CHANGED]≥8%[/CHANGED] |
|---|---|---|---|---|---|---|---|
|  | [CHANGED]vs best performer[/CHANGED] |  |  |  |  |  |  |
|  | [CHANGED]over an ADUO period[/CHANGED] |  |  |  |  |  |  |
| [CHANGED]Extra Operation Hours granted per ADUO period (hours)[/CHANGED] |  |  | [CHANGED]0[/CHANGED] | [CHANGED]70[/CHANGED] | [CHANGED]110[/CHANGED] | [CHANGED]150[/CHANGED] | [CHANGED]190[/CHANGED] |
...
d. [CHANGED]PU Manufacturers meeting the “Additional Development and Upgrade Opportunities” (ADUO) criteria defined in Article 4 of Appendix C5 of the Technical Regulations will be granted the number of additional Operation Hours according to Table 2 for each of the three ADUO performance assessment periods. These hours are cumulative and when apportioned between[/CHANGED]

[PAGE 26]

[CHANGED]years N and N+1 according to the declaration submitted under F5.2.3 and added to the hours given in Table 1 as the Base limits will comprise the total available Operation Hours for the year.[/CHANGED]

[CHANGED]i) Additional Operation Hours granted under ADUO can not be used until the declaration required by F5.2.3 has been approved by the FIA. ii) Any additional Operation Hours apportioned to year N that are not used during that year cannot be carried forward to year N+1.[/CHANGED]

[REMOVED]d. PU Manufacturers who satisfy the criteria laid out in Article 4 of Appendix C5 of the Technical Regulations for “Additional Development and Upgrade Opportunities” (ADUO), will be granted an additional 30% in ICE Operation Hours in the 12-month period starting a week after the 5th Competition in the year when the criteria for ADUO are met.[/REMOVED][COMMENT]\[This part of Article 5.2.7 is currently under review and so it should be noted that it will change in future\].[/COMMENT]
...
f. From the beginning of year N onwards, each Reporting Period, as defined in Article F5.2.1, will have individual ICE Operation hours and ICE Occupancy limits equal to 24% of the annual limit [CHANGED]that was applicable to the PUM at the start date of that Reporting Period[/CHANGED].
