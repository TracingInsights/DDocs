# 2026 Formula 1: Operational Regulations — Issue 07
...
Black Text: Text unchanged from 2026 FIA F1 Regulations - Section F \[Operational\] – Iss 06

[CHANGED]Pink Text[/CHANGED]: Changes relative to 2026 FIA F1 Regulations - Section F \[Operational\] – Iss 06, approved by the
...
**F3.1.2** During the shutdown periods no F1 Team or aailiate to a F1 Team may carry out or instruct a third- party supplier to carry out any of the following activities for or on behalf of the F1 Team:
...
i. Any activity the sole purpose of which is staa wellbeing or entertainment.
...
**F3.2.3** If a PU Manufacturer or aailiate to a PU Manufacturer has factories based in countries where law and/or unions impose a diaerent closing week, these factories may replace one week out of two weeks of the shutdown period specified in Article F3.1.1a. by the locally imposed week and have their second shutdown period specified in Article F3.1.1b. starting no later than 31 December. PU Manufacturers aaected by this must make a declaration to the FIA that the staa concerned will not be permitted to transfer to work in the country that isn’t shutdown during these periods.
...
**F3.2.5** During the shutdown periods no PU Manufacturer or aailiate to a PU Manufacturer may carry out or instruct a third-party supplier to carry out any of the following activities for or on behalf of the PU Manufacturer:
...
g. Any activity the sole purpose of which is staa wellbeing or entertainment.
...
**F3.2.8** For the period until twelve months after confirmation of entry by the FIA, the provisions of this Article 2 will not apply to New PU Manufacturers, as defined in Appendix [CHANGED]C8A7[/CHANGED] of the [REMOVED]Technical[/REMOVED]Regulations.
...
d. Period 6 will end on the 31 December. For the above definition, weeks are assumed to start on a Monday and week 1 is the first week of four days or more in the calendar year. In exceptional circumstances the FIA may revise these ATP at its absolute discretion in accordance with changes or events likely to aaect these restrictions.
...
f. Simulation of diaering exhaust flow
...
c. The maximum overclocked frequency value. NCU = Number of Processing Unit cores used for the solver run. The eaects of multi-threading, where simultaneous threads run on the same physical core will be ignored. NSS = Number of solver wall clock seconds elapsed during the run. Message passing time during calculation must also be included. All information required for auditing of this calculation must be present in the output from the run including the CCF value.
...
b. C is the coeaicient (expressed in percentage form) by which the various parameters need to be multiplied in order to obtain the individual RWTT and RCFD limits for each F1 Team. For RWTT Runs and RATGs the result of the multiplication will be rounded up to the nearest integer.
...
[REMOVED]No F1 Team may use movement of personnel involved in the development, design or testing of aerodynamic surfaces (whether employee, consultant, contractor, secondee or any other type of permanent or temporary personnel) with another F1 Team, either directly or via an external entity, for the purpose of circumventing the requirements of this Article. In order that the FIA may be satisfied that any such movement of staa is compliant with this Article, each F1 Team must inform the FIA of all relevant staa movements at the end of each ATP using the template which may be found in the Guidance Documents (GD’s) and must demonstrate that they have implemented all reasonable measures to avoid the disclosure of information, data or designs between the F1 Teams involved.[/REMOVED]
...
For the avoidance of doubt, if the PU Manufacturer nominates an Existing or Prospective Fuel/Oil Supplier’s Single-Cylinder Dynamometer as one of its allowance of three, it can be used with any type of engine. That engine can only be produced using information from published regulations and Existing or Prospective Fuel/Oil Supplier’s Intellectual Property and it may not include any Intellectual Property IP from the PU Manufacturer except[CHANGED]as[/CHANGED]permitted by the [REMOVED]Technical[/REMOVED]Regulations Appendix [CHANGED]C8A7[/CHANGED] Article 2.2.1b. In addition, The PU Manufacturer must procure that their Existing or Prospective Fuel/Oil Supplier shall provide full access to engine data, engine design, engine Intellectual Property IP and inspection when requested by the FIA. Any other Test Benches, which may be deemed to oaer similar benefits, must also be declared. During a calendar year, the PU Manufacturer may change the PUTBs in use at any time (as limited for each PUTB type by Articles F5.1.2, F5.1.3, F5.1.4, F5.1.5, F5.1.6 and F5.1.7) in order to allow for any commissioning or decommissioning of PUTBs, a facility relocation or because of any force majeure reasons. Such changes of declared PUTBs must be first agreed with the FIA and an updated declaration submitted in order to ensure that no competitive advantage is obtained, and that the intention of the limits imposed in Articles F5.1.2, F5.1.3, F5.1.4, F5.1.5, F5.1.6 and F5.1.7 are not circumvented. Details of the process for Declaration of PUTBs may be found in the [CHANGED]Guidance relevant[/CHANGED][REFERENCE]FIA-F1-DOC.[/REFERENCE][REMOVED]Documents (GD’s)[/REMOVED].
...
## F5.3 Power Unit Test Bench activities aaecting PU Manufacturers a nd F1 Teams

General Principles

**F5.3.1** The objective of any provisions aaecting PUTB activity is to ensure that no F1 Team or PU Manufacturer is at a competitive advantage or disadvantage with respect to other F1 Teams or PU Manufacturers, with respect to their treatment by the Sporting Regulations, Technical Regulations, Financial Regulations-F1Teams, Financial Regulations-PU Manufacturers, and Operational Regulations.
...
c. Customer F1 Teams shall have the opportunity to use a fuel that is supplied by a diaerent fuel supplier to that of the Works F1 Team using the same Power Units. The testing required for such fuel shall give no advantage or disadvantage to the PU Manufacturer in question. The above principles concern solely the competitive advantage or disadvantage that could be obtained by a PU Manufacturer or F1 Team engaged in PUTB activities, and not any commercial arrangements made between PU Manufacturers and F1 Teams to carry out PUTB activities. It is acknowledged that perfect achievement of the above objectives may not be possible at all times. The FIA, the PU Manufacturers and the F1 Teams will engage in good faith discussions to make amendments to these Regulations should it emerge that these objectives are not met.
