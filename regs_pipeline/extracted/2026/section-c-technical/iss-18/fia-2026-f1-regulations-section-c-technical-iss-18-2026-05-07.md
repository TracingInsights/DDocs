# 2026 Formula 1: Technical Regulations — Issue 18
...
WMSC approval date: 07/05/2026

CONVENTION:

Black Text: Text unchanged from 2026 FIA F1 Regulations - Section C \[Technical\] – Iss 17

[CHANGED]Pink Text[/CHANGED]: Changes relative to 2026 FIA F1 Regulations - Section C \[Technical\] – Iss 17, approved by the
...
a. the theoretical MGU-K power resulting from reduction at rates equal to those specified in Article C5.12.6 is less than 100kW;
...
f. car speed is below 210kph, except on specified circuit sectors where a higher speed threshold is defined. [COMMENT]\[FIA\] A higher car speed threshold will be defined for sectors where the car speed may fluctuate around 210kph, potentially causing inconsistent electrical energy deployment.[/COMMENT]
...
b. The engine crankshaft speed sensors connected to the FIA Standard ECU, for the sole purpose of detecting misfire, and subject to FIA approval of the associated software.
...
[CHANGED]The end of each ADUO period will be defined as set out in the table below:[/CHANGED]
...
b. PU Manufacturers whose ICE Performance Index is at least 4% below the best-performing ICE will be eligible for: i 2 additional homologation upgrades in season N ii 2 additional homologation upgrades in season N+1 ADUO homologation upgrades are not cumulative within a season and will only be granted following the first occasion that the PU Manufacturer is assessed by the FIA as eligible for ADUO according to the criteria in this Article.

[PAGE 244]

[COMMENT]\[The proposed 2% threshold and subsequent resolution of the ICE performance index will be validated or adjusted after conclusion of the ongoing activities between PU Manufacturers and F1 Teams related to the on-track ICE performance measurement\][/COMMENT]
