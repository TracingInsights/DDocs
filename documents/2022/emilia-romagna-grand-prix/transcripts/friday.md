F1 - 2022 EMILIA ROMAGNA GRAND PRIX - FRIDAY PRESS CONFERENCE TRANSCRIPT

DRIVER GROUP 1 – Valtteri BOTTAS (Alfa Romeo), Charles LECLERC (Ferrari), Carlos SAINZ (Ferrari), Max VERSTAPPEN (Red Bull), George RUSSELL (Mercedes)
