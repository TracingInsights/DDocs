...
Enclosed FRA DOC 24 - Event Notes V3.pdf
...
24.4 The deterrents (“baguette kerbs”) adjacent to the track at the exit of T5 and T15 have been removed.

24.5 There is an active digital panel placed on top of the pit wall adjacent to the pit exit (driver’s right). Each time a car is leaving the pit lane this panel will display an arow pointing to the left to inform

drivers on track that a car is exiting the pit lane.

![Extracted image from page 8](images/race-directors-event-notes-v3_p8_img1.jpeg)
