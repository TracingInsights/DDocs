...
From The FIA Formula 1 Race Director Document 61

To All Teams, All Officials Date 13 September 2026
...
Enclosed 2026 Spain Grand Prix Competition Notes V3.pdf

Rui Marques

The FIA Formula 1 Race Director

2026 S PANISH G RAND P RIX

11 – 13 September 2026

From The FIA Formula 1 Race Director

To All Officials, All Teams Date 13 September 2026
...
![Extracted image from page 6](images/race-directors-competition-notes-v3_p6_img7.jpeg)
...
15. Lines at the Pit Entry and Pit Exit 15.1 In accordance with Appendix L, Chapter IV, Articles 4 and 6 to the ISC drivers must follow the procedures at pit entry and pit exit. 15.2 Pertaining to Appendix L, Chapter IV, Article 4 to the ISC, any driver passing to the right-hand side of the intersection of the dashed line with the continuous line (as indicated in the image below) will be considered as entering the pit lane.

![Extracted image from page 6](images/race-directors-competition-notes-v3_p6_img6.jpeg)

15.3 For the safe and orderly conduct of the event, during any live session, team personnel are not allowed to cross the area signal at the picture below at the pit exit.

![Extracted image from page 6](images/race-directors-competition-notes-v3_p6_img5.jpeg)

5

15.4 If there is a yellow light displayed on LHS in the pit entry road it will be a warning of an incident at the pit entry road. This signal is not intended for drivers staying on track.

![Extracted image from page 7](images/race-directors-competition-notes-v3_p7_img8.jpeg)

15.5 If there is a yellow light displayed on LHS in the pit exit road (after the pit exit lights) it will be a warning of an incident at the pit entry exit road. This signal is not intended for drivers staying on track.

![Extracted image from page 7](images/race-directors-competition-notes-v3_p7_img9.jpeg)

16. Driving in the Pit Lane During the Race This competition is a track where the pit lane is narrow. For the safe and orderly conduct of this event, when released from their pit stop position during the Race, all cars so released shall be responsible for ensuring that they blend into the fast lane as quickly as possible in a safe and orderly manner without unnecessarily impeding any car already in the fast lane. If this requires the released car to slow down sufficiently to allow car(s) in the fast lane to pass them, then that is what the released car should do. For the avoidance of doubt, in this case a car will be considered to have entered the fast lane when all parts of the car have crossed the line separating the fast lane from the inner lane.
...
18. ERS Hazard Status If the ERS is in a Hazard Status, the relevant team will be required to send mechanics to the pit entry area. This will be done after the session. They will then be picked up by car and taken to their F1 car.
...
21. Removing cars from the grid Cars may be removed from the grid through the gate adjacent to the start line, grid position 9 and finish line.

22. Race Suspension or Starting Procedure Suspension 22.1 In case of Race suspension or Starting Procedure suspension, (except in case of Article B5.14.3 of the FIA F1 Regulations – stopping on the grid), cars will be stopped in the fast lane. The first car must stop in the vicinity of garage 23 (FOM garage). 22.2 Safety Car Resumption Point: Safety Car will leave the pit lane 1 minute before the resumption and wait for the F1 cars before Turn 18. (as per the image below).

![Extracted image from page 8](images/race-directors-competition-notes-v3_p8_img10.jpeg)
...
23. Grid Panel Placement On the right-hand side of the grid.

24. Grid Procedure Article B5.2.4 of the FIA F1 Regulations states that “Any F1 Car which does not complete a reconnaissance lap and reach the grid under its own power will not be permitted to start the TTCS from the grid.”. In the context of this article the grid shall be considered to be the section of track starting from the front of marked grid box #1 and finishing at the grid box #34.

![Extracted image from page 8](images/race-directors-competition-notes-v3_p8_img11.jpeg)

25. Track Limits 25.1 During any LTCS, each time a driver fails to negotiate Turn 22, will result in that lap time and the immediately following lap time may be invalidated by the Stewards.

7

26. Escape Roads 26.1 Run Off Turn 1 – Turn 2 Any driver going straight and who misses Turn 2 and passes to the right hand side of the yellow line, must stay on the right hand side of the yellow line bollard and he may rejoin the track at the far end of the run-off area after the exit of turn 2 (see picture below).

![Extracted image from page 9](images/race-directors-competition-notes-v3_p9_img14.jpeg)

26.2 Run Off at Turn 5 – Turn 5A Any driver going straight and who misses Turn 5A and passes to the right hand side of the yellow line, must stay on the right hand side of the yellow line bollard and he may rejoin the track at the far end of the run-off area at turn 6 (see picture below).

![Extracted image from page 9](images/race-directors-competition-notes-v3_p9_img13.jpeg)

26.3 Run Off at Turn 11 Any driver using the runoff area inside Turn 11 must rejoin track passing on the left hand side of the polystyrene block.

![Extracted image from page 9](images/race-directors-competition-notes-v3_p9_img12.jpeg)

8

27. Light panels: In case of an incident, double yellow light panel will be mirrored on the following panels:

• Panel 6 is two physical panels presenting the same signal at the same time.

• Panels at Turn 12 will be all mirrored.

• Panel 11 will be mirrored on panel 10.

28. Stopping the Qualifying Session

Pursuant to Article B4.3.1b of the FIA F1 Regulations, should any period of the Qualifying

Session be interrupted with less than 90 seconds remaining, the relevant period of the

Qualifying Session will not be resumed.

29. Changes to the Circuit

- Realign white line at the exit of Turn 17.

![Extracted image from page 10](images/race-directors-competition-notes-v3_p10_img15.jpeg)

- Realign white line at the apex of Turns 18.

![Extracted image from page 10](images/race-directors-competition-notes-v3_p10_img17.jpeg)

- Realign white line at the apex of Turns 19.

![Extracted image from page 10](images/race-directors-competition-notes-v3_p10_img16.jpeg)

9

- Realign of the pit entry white line.

![Extracted image from page 11](images/race-directors-competition-notes-v3_p11_img19.jpeg)

30. Pit Lane Starters: Due to the lack of space in the pit exit road, for the safe and orderly conduct of the event, cars queuing in the fast lane, in order to start from the pit lane, must form up in a line before the dashed line reference in the image below. From the moment the formation lap starts cars can move until the pit exit lights.

![Extracted image from page 11](images/race-directors-competition-notes-v3_p11_img18.jpeg)
