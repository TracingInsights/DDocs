...
To All Teams, All Officials Date 05 September 2026
...
Enclosed 2026 Italian Grand Prix Competition Notes V2.pdf

Rui Marques

The FIA Formula 1 Race Director

2026 I TALIAN G RAND P RIX

04 – 06 September 2026

From The FIA Formula 1 Race Director

To All Officials, All Teams Date 05 September 2026
...
14. Lines at the Pit Entry and Pit Exit 14.1 In accordance with Appendix L, Chapter IV, Articles 4 and 6 to the ISC drivers must follow the procedures at pit entry and pit exit. 14.2 Pertaining to Appendix L, Chapter IV, Article 4 to the ISC, any driver passing to the right-hand side of the bollard at Safety Car Line 1 will be considered as entering the pit lane.

![Extracted image from page 6](images/race-directors-competition-notes-v2_p6_img5.jpeg)

15. Stopping the Qualifying Session Pursuant to Article B4.3.1b of the FIA F1 Regulations, should any period of the Qualifying Session be interrupted with less than 80 seconds remaining, the relevant period of the Qualifying Session will not be resumed.
...
17. ERS Hazard Status If the ERS is in a Hazard Status, the relevant team will be required to send mechanics to the pit entry area. This will be done after the session. They will then be picked up by car and taken to their F1 car.

18. Leaving the garage before and during all Sessions 18.1 Before the start of the Free Practice sessions or Qualifying, or prior to the pit exit opening for the reconnaissance laps, no cars may enter the pit lane to proceed to pit exit until 5 minutes before the scheduled start time or announced start time in the case of a delayed session. 18.2 If the Free Practice sessions or Qualifying, or any period thereof is delayed or stopped, cars may only enter the Fast Lane after the re-start time is confirmed via the official messaging system.

19. Places to remove cars from the track Indicated by fluorescent orange panels/paintings on the barriers.

20. Removing cars from the grid Cars may be removed from the grid through the gate adjacent to the grid positions 6 and 21.
...
21.3 When pit exit is open for the resumption of the race, in accordance with Article B5.15.2f, cars must exit the pit lane without undue delay and without leaving a significant gap to the car ahead.

22. Grid Panel Placement On the right-hand side of the grid.

23. Grid Procedure Article B5.2.4 of the FIA F1 Regulations states that “Any F1 Car which does not complete a reconnaissance lap and reach the grid under its own power will not be permitted to start the TTCS from the grid.”. In the context of this article the grid shall be considered to be the section of track starting from the front of marked grid box #1 and finishing at the grid box #38.

![Extracted image from page 7](images/race-directors-competition-notes-v2_p7_img7.jpeg)

24. Track Limits 24.1 During any LTCS, each time a driver fails to negotiate Turn 11, will result in that lap time and the immediately following lap time may be invalidated by the Stewards. 24.2 The dotted white line intersecting the pit exit road marks the track edge.

![Extracted image from page 7](images/race-directors-competition-notes-v2_p7_img6.jpeg)

25. Escape Roads 25.1 Escape Road at Turn 1 – Turn 2 Four rows of polystyrene blocks have been placed in the escape road at the first chicane. In order to ensure the cars are able to re-join the track safely any driver using the escape road must go around the end of each of these rows and re-join the track at the end of the escape road. Drivers may only use the grass if it is clearly unavoidable.

6

![Extracted image from page 8](images/race-directors-competition-notes-v2_p8_img8.jpeg)

25.2 Escape Road at Turn 4 – Turn 5

Any driver going straight and who misses Turn 4 and passes to the right of the gravel trap must stay to the right of the yellow line and the yellow bollard, he may re-join the track at the far end of the asphalt run-off area after the exit of Turn 5.

![Extracted image from page 8](images/race-directors-competition-notes-v2_p8_img9.jpeg)

26. Light panels: In case of an incident, double yellow light panel will be mirrored on the following panels:

• Panel 16 will be mirrored on panel 15.

27. Changes to the Circuit - New asphalt patch at Turn 2.

- New wall and debris fence on the left-hand side of the main straight.

- New negative kerb left hand side before Turn 1 from the 100 meter brake marker.

- New negative kerb right hand side before Turn 4 from the 100 meter brake marker.

- First part of the gravel bed at Turn 5 LHS was replaced by asphalt.

- New negative kerb right hand side before Turn 8 from the 100 meter brake marker.

- New natural grass installed at the right-hand side of Turn 9 (apex).

- New fences on the left-hand side between Turn 10 and Turn 11.

- Pit exit white line shortened (finish in the Safety Car line 2).
