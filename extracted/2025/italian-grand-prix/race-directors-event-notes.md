...
To All Teams, All Officials Date 04 September 2025
...
Enclosed 2025 Italian Grand Prix Event Notes.pdf
...
To All Officials, All Teams Date 4 September 2025
...
![Extracted image from page 4](images/race-directors-event-notes_p4_img1.png)
...
13. Practice starts 13.1 During Free Practice sessions, practice starts may be carried out in the pit exit road on the right-hand side before the end of the pit wall, using one of the painted grid boxes shown in the image below. Cars queuing to perform a practice must keep to the right-hand side of the Pit Exit Road to allow sufficient space for cars not wishing to do a practice start to pass.

3

![Extracted image from page 5](images/race-directors-event-notes_p5_img4.jpeg)
...
![Extracted image from page 5](images/race-directors-event-notes_p5_img3.png)
...
![Extracted image from page 5](images/race-directors-event-notes_p5_img2.jpeg)
...
![Extracted image from page 6](images/race-directors-event-notes_p6_img5.jpeg)

16. Stopping Qualifying Sessions For the safe and orderly conduct of the event, should any period of the Qualifying Session be stopped with less than 80 seconds remaining, the Race Director with the agreement of the Stewards may decide that the relevant period of the qualifying session will not be resumed, i.e. that part of the competition will be stopped.
...
The zone and corresponding light panels are as follows: a) DRS activation 1: 9, 10, 11, 12, 13 b) DRS activation 2: 1, 2, 3

5

19. Track Limits 19.1 In accordance with the provisions of Article 33.3 of the Sporting Regulations, the white lines define the track edges. During Qualifying and the Race, each time a driver fails to negotiate with the track limits, this will result in that lap time being invalidated by the Stewards. Additionally, each time a driver fails to negotiate the exit of turn 11, will result in that lap time and the immediately following lap time may be invalidated by the Stewards.

19.2 The dotted white line intersecting the pit exit road marks the track edge.

![Extracted image from page 7](images/race-directors-event-notes_p7_img8.jpeg)

20. Escape Roads

20.1 Escape Road at Turn 1 – Turn 2 Four rows of polystyrene blocks have been placed in the escape road at the first chicane. In order to ensure the cars are able to re-join the track safely any driver using the escape road must go around the end of each of these rows and re-join the track at the end of the escape road. Drivers may only use the grass if it is clearly unavoidable.

![Extracted image from page 7](images/race-directors-event-notes_p7_img7.png)

20.2 Escape Road at Turn 4 – Turn 5
...
![Extracted image from page 7](images/race-directors-event-notes_p7_img6.jpeg)
...
25. Removing cars from the grid Cars may be removed from the grid through the gates adjacent to grid position 6 and position 21.
...
28. Changes to the Circuit • New gate in the pit wall in front of garage 32.

• Asphalt repair by application of bitumen coating at Turn 1 and Turn 4.
