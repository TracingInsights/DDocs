...
To All Teams, All Officials Date 17 April 2025
...
Enclosed 2025 Saudi Grand Prix Event Notes.pdf

Rui Marques

The FIA Formula One Race Director

2025 S A G P AUDI RABIAN RAND RIX

18 – 20 April 2025

From The FIA Formula One Race Director

To All Officials, All Teams Date 17 April 2025
...
1.4 In case of an incident, the yellow and double yellow light panel will be mirrored on the following panels:

• Panel 4 mirrors panel 5

• Panel 15 mirrors panel 16

• Panel 18 mirrors panel 19
...
Please note that the FIA have introduced an Appendix Index File which contains all the relevant and active Appendix documents, Technical and Sporting Directives. The latest version of this Index file (“2025 Formula 1 Appendix – iss 6 – 2025-04-15.xlsx”) and all relevant documents can be found on the FIA SFTP site.

Competitors are hereby required to ensure compliance with these directives for the safe and orderly conduct of the Event.

Erratum to “2025 Formula 1 Appendix – iss 6 – 2025-04-15.xlsx”: The current version of TD003 should read “TD003Q”.

9) Support Races team barrier placement and Movements Team barrier placement prior to and during all support category practice sessions and races: No more than (2) two meters from the garages.

Please ensure that your pit stop gantry arms are moved back towards the garage during all support
...
10.1 During free practice sessions and any time the pit exit is open for the race, practice starts may only be carried out on the asphalt area on the LHS of the fast lane using one of the painted grid boxes. For the avoidance of doubt, practice starts may not be carried out during Qualifying Sessions.
...
13.2 For safety reasons drivers committed to entering the pit lane, must keep to the left of the white line preceding the pit entry which starts approximately 1.5m after the DRS Activation 3 line, as indicated in the picture

![Extracted image from page 5](images/race-directors-event-notes-v2_p5_img4.jpeg)

13.3 Pertaining to Chapter 4, Article 4 of Appendix L to the ISC any driver passing to the left hand side of the pit entry after the safety car line 1 will be considered as entering the pit lane.

![Extracted image from page 5](images/race-directors-event-notes-v2_p5_img3.jpeg)

4

13.4 Except in a case of force majeure (accepted as such by the Stewards), the crossing by any part of the tyre, in any direction, of the painted area between the pit entry and the track, by a driver is prohibited.

![Extracted image from page 6](images/race-directors-event-notes-v2_p6_img5.jpeg)

13.5 During the reconnaissance laps prior to the race drivers are allowed to cross the white line separating the pit exit road from the circuit in the pit exit road.

14) Stopping Qualifying Sessions
...
16) DRS during all free practice sessions and the race
...
The zones and corresponding light panels are as follows: a) DRS activation 1: 13, 14, 15 b) DRS activation 2: 17, 18, 19, 20 c) DRS activation 3: 21, 22, 1, 2

17) DRS during qualifying sessions

DRS Detection will be automatically disabled in each individual zone if any of the light panels in that zone are displaying yellow.

The zones and corresponding light panels are as follows: a) DRS activation 1: 13, 14, 15 b) DRS activation 2: 17, 18, 19, 20 c) DRS activation 3: 21, 22, 1
...
Cars may be removed from the grid through the gates adjacent to grid positions 1, 13 and 24.
...
26.1 The pit entry and pit exit white lines are highlighted blue.

26.2 The safety car lines are highlighted blue.

26.3 Blue line behind the white line at the apex of turns 2, 5, 8, 9, 14, 17.

26.4 Blue line behind the white line at the exit of turns 8, 19, 23.
