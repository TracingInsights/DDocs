...
Title Race Director's Event Notes V

Description Race Director's Event Notes V

Enclosed 2025 Hungarian Grand Prix Event Notes V2.pdf

Rui Marques

The FIA Formula One Race Director

2025 H G P UNGARIAN RAND RIX

01 August – 03 August 2025

From The FIA Formula One Race Director

To All Officials, All Teams Date 01 August 2025
...
12. Support Races team barrier placement and movements Team barrier placement prior to and during all support category practice sessions and races: No more than three (3) meters from the garages.
...
Thus, after the start or re-start of a Free Practice session or Qualifying session, if there is a suitable gap in a queue of cars in the fast lane, such that a driver can blend into the fast lane safely and without unnecessarily impeding cars already in the fast lane, they are free to do so.
...
15. Lines at the Pit Entry and Pit Exit 15.1 In accordance with Chapter 4, Articles 4 and 6 of Appendix L to the ISC drivers must follow the procedures at pit entry and pit exit. 15.2 After SC line 2, there is a continuous white line separating the cars coming from the pits from the cars on the track. For safety reasons, drivers leaving the pits, must stay to the right of the aforementioned line. 15.3 Pertaining to Chapter 4, Article 4 of Appendix L to the ISC any driver passing to the right hand side of the bollard at safety car line 1 will be considered as entering the pit lane.

![Extracted image from page 6](images/race-directors-event-notes-v2_p6_img5.jpeg)

15.4 During the reconnaissance laps prior to the race drivers are allowed to cross the white line separating the pit exit road from the circuit. 15.5 For the safe and orderly conduct of the event, during any live session and while the pit exit is open prior to the start of the race, team personnel are not allowed to cross the pit entry speed limit line, as indicated in the picture below.

5

![Extracted image from page 7](images/race-directors-event-notes-v2_p7_img7.jpeg)

16. Stopping Qualifying Sessions For the safe and orderly conduct of the event, should any period of the Qualifying Session be stopped with less than 70 seconds remaining, the Race Director with the agreement of the Stewards may decide that the relevant period of the qualifying session will not be resumed, i.e. that part of the competition will be stopped.
...
The zone and corresponding light panels are as follows: a) DRS activation 1: 19, 1, 2, 3 b) DRS activation 2: 3, 4, 5

19. DRS during Qualifying: DRS Detection will be automatically disabled in each individual zone if any of the light panels in that zone are displaying yellow.

The zone and corresponding light panels are as follows: a) DRS activation 1: 19, 1, 2 b) DRS activation 2: 3, 4, 5

20. Track Limits 20.1 In accordance with the provisions of Article 33.3 of the Sporting Regulations, the white lines define the track edges. During Qualifying and the Race, each time a driver fails to negotiate with the track limits, this will result in that lap time being invalidated by the Stewards. Additionally, each time a driver fails to negotiate the exit of turn 14, will result in that lap time and the immediately following lap time may be invalidated by the Stewards.

20.2 The dotted white line intersecting the pit exit road marks the track edge.

6

![Extracted image from page 8](images/race-directors-event-notes-v2_p8_img8.jpeg)

21. Unsafe or Unknown ERS Status If the status of the ERS changes to unsafe or unknown, the relevant team will be required to send mechanics to the pit entry area. They will then be picked up by car to be brought to their car after the session.
...
25. Removing cars from the grid Cars may be removed from the grid through the gates adjacent to grid positions 6 and 18.

26. Race Suspension or Starting Procedure Suspended In case of race suspension or starting procedure suspended, (except in case of Article 57.2 – stopping on the grid), cars will be stopped in the fast lane with the first car stopped in the vicinity last team garage.

27. Car number light panels for the start On the right-hand side of the grid.

28. Changes to the Circuit • Resurfaced the main straight • Changed the grass strip exit turn 5 to a gravel strip. • New concrete blocks with fences at Turn 14 LHS until the bridge • Resurfaced the pit lane • Alignment of the white line and added a blue line at the exit of Turn 7

29. Light panels: In case of an incident, the yellow and double yellow light panel will be mirrored on the following panels:

• Panel 9 will be mirrored on panel 8

7

30. FP1 and FP2 Marshalling System Test

Once the last car on track has completed its’ practice start in accordance with Article 38.3 and crossed the Line, a Virtual Safety Car (VSC) will be deployed. All drivers must respect the VSC procedure and proceed into the pit lane as required by Art. 38.2. Whilst the VSC is deployed, periodically a Double Yellow Flag will be set and cleared in Turn 13 and Turn 14, to simulate an incident in the marshalling sector surrounding the Pit Entry Road. All drivers must respect the Double Yellow Delta should they encounter it during this test.
