...
To All Teams, All Officials Date 23 October 2021
...
Enclosed 2021 United States F1 Grand Prix Event Notes V3 Doc 26.pdf
...
14.2 The following milling of the track surface will take place in the following location prior to the event:
...
21.4 General - Turn 9 Exit and Turn 19 Exit
...
b) Each time any car fails to negotiate Turn 9 Exit, or Turn 19 Exit by using the track, teams will

be informed via the official messaging system.

c) On the third occasion of a driver failing to negotiate Turn 9 and/or Turn 19 Exit by using the
