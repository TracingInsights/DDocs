...
To All Teams, All Officials Date 17 June 2021
...
Enclosed 2021 French F1 Grand Prix Event Notes V2 Doc 7.pdf
...
15.1 The provisions of Technical Directive Ref: TD012 Issue A and TD003 Issue C B must be complied with at all times during the Event.
...
15.3 Both TD012 Issue: A and TD003 Issue C B will be amended after the Event to reflect any additional operational requirements as required.
...
a) Each time any car fails to negotiate Turns 1-2 or Turns 3-5 and/or Turns 8-9 by using the track

as described above, teams will be informed via the official messaging system.

4/6

b) On the third occasion of a driver failing to negotiate Turns 1-2 or Turns 3-5 and/or Turns 8-9

by using the track during the race, he will be shown a black and white flag, any further cutting

will then be reported to the stewards.
...
23.1 Indicated by fluorescent orange red boards with a white letter “F” attached to the debris fences and barriers.

Places where drivers can leave the track

Indicated by white panels with a green “running man” attached to the debris fences.
...
![Extracted image from page 7](images/race-directors-event-notes-version-2_p7_img3.jpeg)
...
![Extracted image from page 11](images/race-directors-event-notes-version-2_p11_img6.png)
