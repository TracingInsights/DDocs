...
To All Teams, All Officials Date 06 May 2021
...
Enclosed 2021 Spanish F1 Grand Prix Event Notes Doc 3.pdf

Michael Masi

The FIA Formula One Race Director

2021 S G P PANISH RAND RIX

6 – 9 May 2021

From The FIA Formula One Race Director Document 3

To All Teams, All Officials Date 6 April 2021
...
14.1 The yellow combination bumps at the apex of Turn 8 have been extended toward the exit of Turn 7 by approximately 20m.

14.2 The Turn 9 apex kerb has been removed and replaced with a new kerb of the same type.

14.3 Turn 10 is a completely new configuration

14.4 The rear of the Turn 13 combination kerb has been backfilled to provide a gradual transition.
...
a) Zone 1: Panels 11, 12

b) Zone 2: Panels 17, 1, 2
...
of the speed bumps across the run-off area or between them, must then re-join the track by

driving to the left of the two bollards located before the entry to Turn 3.
...
a) Each time any car fails to negotiate Turn 2 by using the track as described above, teams will
...
25.1 To assist social distancing in accessing the grid prior to the commencement of the start procedure, Team personnel and equipment will be granted access to the grid from 1400hrs on Sunday 9th May.

26) Removing cars from the grid

26.1 Through the two gates in the pit wall, the first located adjacent to grid position 2 and the second located adjacent to grid position 17.
...
dralloB yaM tiP X 7– yrtnE sutatS slenap 1 noisreV tiP
...
| Grand Prix of Spain 07/05-09/05/2021 (21R04BCN) |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| Minimum Starting P |  |  | Camber limit -3.25 ° | Blistering sensitivity Low |
| --- | --- | --- | --- | --- |
| Slicks 22.0 psi | Inter 21.0 psi | Wet 20.0 psi |  |  |

Front Rear 19.5 psi 20.5 psi 19.5 psi -1.75 ° Medium
