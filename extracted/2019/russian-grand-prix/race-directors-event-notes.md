...
To All Teams, All Officials Date 26 September 2019
...
Enclosed 2019 Russian F1 Grand Prix Race Directors Event Notes Doc 2.pdf
...
12.1 Any driver who fails to negotiate Turn 2 by using the track, and who passes completely to the left of the orange kerb element on the apex, must then re-join the track by driving through the three arrays of blocks in the run-off, to the left of the first, to the right of the second, to the left of the third. (See attached image)
