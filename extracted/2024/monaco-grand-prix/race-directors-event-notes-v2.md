...
The FIA Formula One Race Director From The FIA Formula One Race Director To All Teams, All Officials Document 14

Date 24 May 2024 Time 14:56 Title Race Director's Event Notes V2

Description Race Director's Event Notes V2

**Enclosed 2024 Monaco Grand Prix - Event Notes V2.pdf**
...
2 When the faster car is within 1.2s of the car about to be lapped blue flags will be shown to the slower car (in addition to blue light panels, blue cockpit lights and a message on the timing monitors) and the driver must allow the following driver to overtake at the first available opportunity.
...
No practice starts may be carried out at the end of the pit lane.
...
**13) Pirelli Trackside Operations regarding personnel (Engineering/Fitting) for Monaco**

13.1 To limit the number of personnel for Monaco, the following procedure is implemented.
...
4 procedures at pit entry and pit exit.
...
## 20) Unsafe or Unknown ERS Status

If the status of the ERS changes to unsafe or unknown, the relevant team will be required to send mechanics at the end of the session to the area in front of the race control tower. They will then be driven to their car with a race control car.
...
Cars may be removed from the grid through the Pit Lane Exit.
