...
Enclosed 2024 Italian Grand Prix - Event Notes V4.pdf
...
![Extracted image from page 5](images/race-directors-event-notes-v3_p5_img1.png)

4

16.2 Escape Road at Turn 4 – Turn 5

Any driver going straight and who misses Turn 4 and passes to the right of the shaded area gravel trap must stay to the right of the yellow line and the yellow bollard, he may re-join the track at the far end of the asphalt run-off area after the exit of Turn 5. Any driver who misses Turn 4 and crosses the shaded area before the apex kerb of Turn 5 must stay to the right of the green bollard, he may re-join the track at the far end of the asphalt run-off area after the exit of Turn 5.

![Extracted image from page 6](images/race-directors-event-notes-v3_p6_img2.png)

17) Unsafe or Unknown ERS Status

If the status of the ERS changes to unsafe or unknown, the relevant team will be required to send mechanics in front of the race control during the session. They will then be picked up by two race control scooters that will drive them to their car. Additionally, a race control car will be available only after the end of a session to bring the relevant mechanics to their car.
...
• The track has been fully resurfaced. 5

• All kerbs have been replaced with new kerbs. • The bollards in the run-off in Turn 2 on LHS have been replaced with a 2.5m wide gravel strip. • Between Turn 4 and Turn 5 on RHS a 2.5m wide gravel strip has been installed with a distance of 1m from the track edge.
