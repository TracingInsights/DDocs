...
To All Teams, All Officials Date 29 August 2024
...
Enclosed 2024 Italian Grand Prix - Event Notes.pdf
...
To All Officials, All Teams Date 29 August 2024
...
![Extracted image from page 6](images/race-directors-event-notes-v2_p6_img5.png)

17) Unsafe or Unknown ERS Status

If the status of the ERS changes to unsafe or unknown, the relevant team will be required to send mechanics in front of the race control during the session. They will then be picked up by a race control scooter that will drive them to their car.
...
21) Cars may be removed from the grid through the gates adjacent to grid positions 6 and through pit exit.
...
• The track has been fully resurfaced. • The bollards in the run-off in Turn 2 on LHS have been replaced with a 2.5m wide gravel strip. • Between Turn 4 and Turn 5 on RHS a 2.5m wide gravel strip has been installed with a distance of 1m from the track edge.
