...
Enclosed 2024 Singapore Grand Prix - Event Notes V2.pdf

Niels Wittich

The FIA Formula One Race Director

2024 S G P INGAPORE RAND RIX

20 – 22 September 2024

From The FIA Formula One Race Director

To All Officials, All Teams Date 22 September 2024
...
Team barrier placement prior to and during all support category practice sessions and races: No more than (1) one meter from the garages.
...
10.1 During each Free Practice session, practice starts may be only carried out on the LHS after the pit exit lights.

10.2 During the time the pit exit is open for the Race, practice starts may be carried out no further forward than the dashed white line across the pit exit. Drivers wishing to carry out a start should stop on the left to allow other cars to pass on their right. During this time any driver passing a car which has stopped to carry out a practice start may cross the white line that is referred to in 12.1 below.
...
12.2 For safety reasons when driving in the first part of the pit lane, prior to the first team garage, drivers must keep to the right of the two bollards separating the fast lane and inner lane.
...
c) DRS Activation 3: Panels 13, 14, 15

d) DRS Activation 4: Panels 16, 1, 2
...
• Removal of the artificial grass on RHS in Turn 2 and Turn 3.

• New 4.0 m gate at Turn 5 on RHS.

• New 6.0 m gate at Turn 15 on LHS.

• Opening closed at MP15.5 on LHS

• Resurfacing between entry Turn 3 until exit Turn 8.

• Resurfacing between exit Turn 10 until exit Turn 12.

• Resurfacing between exit Turn 14 until entry Turn 16.

• Resurfacing between exit Turn 16 until exit Turn 17.
