...
Title Race Directors' Event Notes Version 6

Description Event Notes Version 6

Enclosed 2020 Tuscan F1 Grand Prix Event Notes v6 Doc 31 130920.pdf
...
EVENT NOTES VERSION 6 General Instructions
...
19.5 For safety reasons, when driving in the first part of the pit lane, prior to the first pit lane garage, drivers must keep to the left of the two orange bollards separating the fast lane and inner lane. See
...
a) The location of the DRS remains unchanged. A painted line across the track has now been

added at the location of the DRS Boards.

30.2 Safety Car

a) The Drivers are reminded that the Safety Car has changed colour and is red at this Event.
...
IMAGE 4 – ORANGE BOLLARDS AT START OF PIT LANE

![Extracted image from page 10](images/race-directors-event-notes-version-6_p10_img1.jpeg)

DRIVERS MUST KEEP TO THE LEFT OF THE ORANGE BOLLARDS INDICATED BY THE RED ARROWS ABOVE
...
![Extracted image from page 14](images/race-directors-event-notes-version-2_p13_img4.jpeg)
