...
Enclosed 2020 Belgian F1 Grand Prix Event Notes V3 Doc 18 290820.pdf
...
20.6 Turn 14 – Exit a) The track limit at the exit of Turn 14 is defined as having no part of the car in contact with the

yellow and red painted kerbs.
...
28.1 Drivers should not complete a full slowing down lap but should enter the pit lane using the pit exit and proceed down the pit lane in the “wrong” direction. all cars will then be stopped in the weighing

area.

28.2 The first three must follow the post-race procedure which will be distributed prior to the start of the race.

29) Any other business

29.1 Blue Flags

![Extracted image from page 7](images/race-directors-event-notes-version-2_p7_img1.png)

Michael Masi

FIA Formula One Race Director

PRACTICE START LOCATION
...
![Extracted image from page 9](images/race-directors-event-notes-version-3_p9_img2.jpeg)
