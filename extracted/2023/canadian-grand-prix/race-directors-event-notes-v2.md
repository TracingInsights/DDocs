...
Enclosed 2023 Canadian Grand Prix - Event Notes V2.pdf
...
3.3 Double Waved during VSC or SC: Any driver passing through a double waved yellow marshalling sector during a VSC or SC, in addition to the requirements in 3.2 above, must remain positive of the
...
6.2 No more than three (3) team personnel per car are permitted into the Parc Fermé area for the sole purpose of fitting cooling fans and any work required by the FIA.
...
(“2023 Formula 1 Appendix – iss 3 – 2023-05-12.xlsx”) and all relevant documents can be found on
...
more than (3) three meters from the garages.

It is not permitted to push cars to or from the weighing area at any time a support category is in the
...
To help mitigate any differences in speed, cars on out or slow laps are requested to stay clearly

offline where possible between Turns 10 and 13.

14) Practice starts

14.1 Practice starts may be carried out at the pit exit on the left-hand side after the pit exit lights.

14.2 For reasons of safety and sporting equity, cars may not stop in the fast lane at any time the pit exit is open without a justifiable reason (a practice start is not considered a justifiable reason).

14.3 Additionally, practice starts may be carried out on the track at the end of each free practice session. Any car on the track when the chequered flag is shown may then complete another lap and, instead

of entering the pits, proceed to the grid and carry out a practice start.

14.4 All drivers carrying out a practice start must do so by pulling as far forward on the grid as possible and, if necessary, should wait for others to carry out a start before getting to a grid position further
...
14.5 If any driver appears to be disregarding any of the above a red flag will be displayed and the possibility to carry out any further starts will be immediately terminated.
...
17.1 In accordance with the provisions of Article 33.3, the white lines define the track edges. During Qualifying and the Race, each time a driver fails to negotiate with the track limits, this will result in

that lap time being invalidated by the Stewards.

17.2 Any driver who fails to negotiate with Turn 9 or Turn 14 and passes completely to the left of the orange apex kerb must keep completely to the left of the orange block/bollard on the exit of the

corner and re-join the track at the far end of the asphalt run-off.
...
17.3 Any driver who fails to negotiate with Turn 1 should re-join the track at the far end of the asphalt run-off at the entry of Turn 2.

![Extracted image from page 6](images/race-directors-event-notes-v2_p6_img3.jpeg)
...
Cars may be removed from the grid via the pit exit or pit entry.

21) Race Suspension

21.1 In case of a race suspension, cars will be stopped in the fast lane of the pits in the vicinity of the last garage.

21.2 The following procedure for resuming a race with a standing start procedure will apply for the Race in Montreal:
...
• Pit exit green light - SC will leave the pit lane with its lights on, lights will be extinguished after

1 second.

• 1 Minute after the SC has left the pit lane, all drivers leave the pit lane and proceed to the

grid without overtaking.
...
• Concrete wall shortened by (1) one element in the run-off at Turn 1.
